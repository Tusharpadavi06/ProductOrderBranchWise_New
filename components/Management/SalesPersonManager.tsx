...
const INITIAL_STAFF_DATA = [
  ...
  { branch: 'Bangalore', name: 'Hari Prasad' },
  { branch: 'Bangalore', name: 'Tarachand' },
  { branch: 'Bangalore', name: 'Bangalore HO' },
  { branch: 'Tirupur', name: 'Alexander Pushkin' },
  { branch: 'Tirupur', name: 'R. Subramanian' },
  { branch: 'Tirupur', name: 'Ravi Varman' },
  { branch: 'Tirupur', name: 'Subramani' },
          ...
          <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100 min-h-[350px]">
            ...
            {loading ? (
              ...
              <div className="space-y-2 max-h-[350px] overflow-y-auto pr-2 custom-scrollbar">
                {salesPersons.map((person: {id: string, name: string}) => (
                  <div 
                    key={person.id} 
